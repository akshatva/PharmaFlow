...
export function BackgroundPaths({
  ...
  return (
    ...
    >
      ...
      <div
        className={`container relative z-10 mx-auto px-4 text-center md:px-6 ${contentClassName ?? ""}`}
      >
        <motion.div
          initial={{ opacity: 0 }}
          animate={{ opacity: 1 }}
            ...
            <>
              ...
              {showDefaultCta ? (
                <div className="group relative inline-block overflow-hidden rounded-2xl bg-gradient-to-b from-black/10 to-white/10 p-px shadow-lg backdrop-blur-lg transition-shadow duration-300 hover:shadow-xl">
                  <Button
                    variant="ghost"
                    className="rounded-[1.15rem] border border-black/10 bg-white/95 px-8 py-6 text-lg font-semibold text-black backdrop-blur-md transition-all duration-300 group-hover:-translate-y-0.5 hover:bg-white/100 hover:shadow-md"
                  >

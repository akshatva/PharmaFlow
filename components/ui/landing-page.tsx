...
export function DesignAgency() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-gradient-to-br from-background via-background to-muted/20">
      ...
      >
        <div className="container flex h-16 items-center justify-between border-x border-muted mx-auto">
      ...
      <footer className="w-full border-t">
        <motion.div
          ...
          viewport={{ once: true }}
          variants={fadeIn}
          className="container grid gap-3 px-4 py-10 md:px-6 lg:grid-cols-4 border-x border-muted mx-auto"
        >
          <div className="space-y-3">
            <Link href="/" className="flex items-center space-x-3">
              <motion.div

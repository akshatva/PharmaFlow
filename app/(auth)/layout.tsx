...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-6 py-10 sm:py-14">
      <div className="grid w-full max-w-6xl overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-panel sm:rounded-[32px] md:grid-cols-[1.02fr_0.98fr]">
        ...
        <section className="bg-white px-5 py-8 sm:px-6 md:px-12 md:py-14">{children}</section>
      </div>
    </main>
  );
}
